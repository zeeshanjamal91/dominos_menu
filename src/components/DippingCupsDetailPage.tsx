    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-100 py-4 px-4">
        <div className="max-w-lg mx-auto">
          <h1 className="text-xl sm:text-2xl font-bold leading-tight text-gray-800">DOMINO'S DIPPING CUPS</h1>
        </div>
      </div>
              ...
              <div className="p-4">
                <div className="flex items-start space-x-3 mb-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-sm text-gray-500 mb-2 block">{item.calories}</span>
